...
'''
POLYMORPHISM
In the area below, create a single list to hold all of the people created above.
Use a single loop to print the data from each object and the results of the calc_pay method for each of them.
'''
